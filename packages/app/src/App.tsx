...
const NAV: Array<{ id: Nav; label: string; icon: LucideIcon; group: string }> = [
  { id: 'loops', label: 'Loops', icon: RefreshCw, group: 'Studio' },
  { id: 'projects', label: 'Projects', icon: FolderGit2, group: 'Studio' },
  { id: 'chats', label: 'Chats', icon: MessagesSquare, group: 'Studio' },
  { id: 'overview', label: 'Overview', icon: LayoutDashboard, group: 'Insights' },
  { id: 'usage', label: 'Usage', icon: BarChart3, group: 'Insights' },
  { id: 'models', label: 'Models', icon: Sparkles, group: 'Insights' },
  { id: 'assets', label: 'Rules & Skills', icon: ScrollText, group: 'Config' },
  { id: 'marketplace', label: 'Marketplace', icon: Store, group: 'Config' },
  { id: 'settings', label: 'Settings', icon: SettingsIcon, group: 'Config' },
];
